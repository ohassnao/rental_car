  ...
  <div class="grid">
    ...
    <form action="Register" method="post" class="form login">
      ...
      <div class="form__field">
        ...
        <input autocomplete="username" id="login__nom" type="text" name="nom" class="form__input" placeholder="nom" required>
      </div>
      <div class="form__field">
        <label for="login__username"><svg class="icon">
            <use xlink:href="#icon-user"></use>
          </svg><span class="hidden">Prenom</span></label>
        <input autocomplete="username" id="login__prenom" type="text" name="prenom" class="form__input" placeholder="Prenom" required>
      </div>
      <div class="form__field">
        ...
        <input autocomplete="email" id="login__email" type="text" name="email" class="form__input" placeholder="email" required>
            ...
            <div class="form__field">
        <label for="login__adresse"><svg class="icon">
            <use xlink:href="#icon-user"></use>
          </svg><span class="hidden">Email</span></label>
        <input autocomplete="adresse" id="login__adresse" type="text" name="adresse" class="form__input" placeholder="adresse" required>
      </div>
      <div class="form__field">
        <label for="login__username"><svg class="icon">
            <use xlink:href="#icon-user"></use>
