            ...
            <nav class="navbar navbar-expand-lg bg-secondary navbar-dark py-3 py-lg-0 pl-3 pl-lg-5">
                ...
                <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                    <div class="navbar-nav ml-auto py-0">
                        <a href="ClientAdmin.jsp" class="nav-item nav-link active">Client</a>
                        <a href="reservationAdmin.jsp" class="nav-item nav-link ">Reservation</a>
...
<div class="container-fluid bg-white pt-3 px-lg-5">
    ...
    <div class="container-fluid page-header">
        <h1 class="display-3 text-uppercase text-white mb-3">Client List</h1>
        <div class="d-inline-flex text-white">
            <h6 class="text-uppercase m-0"><a class="text-white" href="">Home</a></h6>
            <h6 class="text-body m-0 px-3">/</h6>
            <h6 class="text-uppercase text-body m-0">Client List</h6>
        </div>
    </div>
    <!-- Page Header Start -->
...
<div class="container-fluid py-5">
    <center><h2>Client Table</h2></center>
